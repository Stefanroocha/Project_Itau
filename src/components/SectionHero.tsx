        ...
        <section className="w-full lg:h-[704px] bg-[url('../assets/bg-hero.jpg')] bg-no-repeat bg-center bg-cover">
            <Container className="flex items-center justify-center md:justify-between w-full max-w-[1246px] px-2 lg:px-[15px] mx-auto">
                <div className="flex-1 w-[600px] md:w-[560px]">
                    <h1 className="text-white w-[400px] lg:w-[512px] text-[50px] mb-6 mt-6 md:text-7xl font-bold lg:mb-6">Tenha seu banco na palma da mão.</h1>
                    <p className="text-white text-center md:text-start text-[18px] lg:w-[512px] mb-9 md:mb-8">Todas operações que você precisa em um só lugar. Simples, completo e feito pra você.</p>
                    ...
                    <button className="flex items-center gap-3 mb-10 md:items-start lg:items-start">
                        ...
                        <span className="text-white md:text-sm font-bold">Continue explorando</span>
                    </button>
                </div>
